...
class Step3PostProcessor:
    ...
    def step3_single_request(self, image_description: str, question: str, answer: str) -> Dict[str, Any]:
        ...
        5. No need to repeat the requirements I've given you. Please start the analysis directly.
        Don't expose the user's requirements in your reasoning process; instead, analyze it like a true professional doctor. requirements in your reasoning process; instead, analyze it like a true professional doctor
        """
...
def main():
    ...
    parser.add_argument("--output_file", type=str, default="/root/autodl-tmp/HealthGPT/Cot/PMC-VQA/PMC-VQA_tiny_hou20/PMC-VQA_results3_hou20_v5.csv", help="输出文件路径")
