...
def infer():
    ...
    parser.add_argument("--question-file", type=str, default="/root/autodl-tmp/HealthGPT/question_com.jsonl")
    parser.add_argument("--output_file", type=str, default="/root/autodl-tmp/HealthGPT/response_output_com_batchinfer.csv")
    parser.add_argument("--occupancy_output_file", type=str, default="/root/autodl-tmp/HealthGPT/occupancy_com_batchinfer.csv")
    ...
    for line in tqdm(questions):
        ...
        result = pd.DataFrame([[line['image'][0], line["image"], response]], columns=["classfier", "Image_Path", "Response"])
        # 追加写入 CSV，避免占用过多内存
