...
def infer():
    ...
    parser.add_argument("--question-file", type=str, default="/root/autodl-tmp/HealthGPT/question_VQARAD.jsonl")
    parser.add_argument("--output_file", type=str, default="/root/autodl-tmp/HealthGPT/response_output_com_batchinfer-VQARAD.csv")
    ...
    for line in tqdm(questions):
        ...
        result = pd.DataFrame([[line["image"], response]], columns=["Image_Path", "Response"])
        # 追加写入 CSV，避免占用过多内存
