...
def main():
    ...
    parser.add_argument("--step1-file", type=str, default="/root/autodl-tmp/HealthGPT/ZDH/depart_three/step1_results.json")
    parser.add_argument("--output-file", type=str, default="/root/autodl-tmp/HealthGPT/ZDH/depart_three/step2_results.json")
