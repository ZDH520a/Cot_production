...
def main():
    ...
    parser.add_argument("--question-file", type=str, default="/root/autodl-tmp/HealthGPT/ZDH/train_qa.json")
    parser.add_argument("--output-file", type=str, default="/root/autodl-tmp/HealthGPT/ZDH/3000/step1_results.json")
