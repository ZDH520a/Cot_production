...
def infer():
    ...
    parser.add_argument("--question-file", type=str, default="/root/autodl-tmp/HealthGPT/VQAMed_VQA.jsonl")
    parser.add_argument("--output_file", type=str, default="/root/autodl-tmp/HealthGPT/response_output_com_batchinfer-VQAMed.csv")
    ...
    for line in tqdm(questions):
        ...
        question = line["text"]
        img_path = os.path.join("/root/autodl-tmp/HealthGPT/VQA_Med", line["image"])
